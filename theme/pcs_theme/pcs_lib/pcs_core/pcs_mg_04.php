...
if (!empty($_POST['tp_select']) && $_POST['tp_select'] == 'yes') {
        ...
        while ($sql_tp_spl_arr = sql_fetch_array($sql_tp_spl)) {
            ...
            <tr>
                ...
                <td class="jnt_td"><a
                        ...
                        <font style='font-size:25px;'> <b> <?php echo $sql_tp_spl_arr['tp_no']; ?></b></font></a></td>
                <td class="jnt_td"><?php if ($sql_tp_spl_arr['tp_photo1_by']) {
                        echo $sql_tp_spl_arr['tp_photo1_by'] . '<br>' . $sql_tp_spl_arr['tp_photo1_tm'];
                    } ?></td>
                <td class="jnt_td"><?php if ($sql_tp_spl_arr['tp_photo1_by']) {
                        photo_thumb('tp', $sql_tp_spl_arr['tp_photo1'], '', 150);
                    } ?></td>
                <td class="jnt_td"><?php if ($sql_tp_spl_arr['tp_photo2_by']) {
                        echo $sql_tp_spl_arr['tp_photo2_by'] . '<br>' . $sql_tp_spl_arr['tp_photo2_tm'];
                    } ?></td>
                <td class="jnt_td"><?php if ($sql_tp_spl_arr['tp_photo2_by']) {
                        photo_thumb('tp', $sql_tp_spl_arr['tp_photo2'], '', 150);
                    } ?></td>
                <td class="jnt_td"><?php if ($sql_tp_spl_arr['tp_photo3_by']) {
                        echo $sql_tp_spl_arr['tp_photo3_by'] . '<br>' . $sql_tp_spl_arr['tp_photo3_tm'];
                    } ?></td>
                <td class="jnt_td"><?php if ($sql_tp_spl_arr['tp_photo3_by']) {
                        photo_thumb('tp', $sql_tp_spl_arr['tp_photo3'], '', 150);
                    } ?></td>
            </tr>
    ...
    <table class="main">
        ...
        <tr>
            <td class="main_td"
            ="width:120px;"><?php echo $j_area[$j]; ?></td>
            ...
            ?>
            <td class="main_td"
            ="width:120px;"><?php echo $sql_tp_qty; ?></td>
