...
<style>
	input {
		padding:0px 0px 0px 5px; text-align:center;width:95%;height:50px;font-size:30px;border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;
	}
</style>

<p>&nbsp;
<p align="center"><canvas id='cv' width='1050' height='743' style='border:1px solid black;' > </canvas></p>
...
<tr>
	...
	<td class="main_td" style="width:15%"><input type="text" name="fontsize" value="<?php echo $sql_dwg_spec_array['fontsize']; ?>"></td>
	<td class="main_td td_sub" style="width:15%"> Line width </td>
	<td class="main_td" style="width:15%"><input type="text" name="linewidth" value="<?php echo $sql_dwg_spec_array['linewidth']; ?>"></td>
	<td class="main_td td_sub" style="width:15%"> Package no. </td>
	<td class="main_td" ><input type="text" name="pkg_x" value="<?php echo $sql_dwg_spec_array['pkg_x']; ?>"></td>
	<td class="main_td" ><input type="text" name="pkg_y" value="<?php echo $sql_dwg_spec_array['pkg_y']; ?>"></td>
</tr>
</tbody>
</table>
<table class="main">
...
<tr>
	...
	<td class="main_td" style="width:15%"><input type="text" name="qr_x" value="<?php echo $sql_dwg_spec_array['qr_x']; ?>"></td>
