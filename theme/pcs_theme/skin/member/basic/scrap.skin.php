...
<div id="scrap" class="new_win">
    ...
    <ul>
        ...
        <li>
            ...
            <a href="<?php echo $list[$i]['del_href'];  ?>" onclick="del(this.href); return false;" class="scrap_del"><i class="fa fa-trash-o" aria-hidden="true"></i><span class="sound_only">Delete</span></a>
        </li>
        <?php }  ?>

        <?php if ($i == 0) echo "<li class=\"empty_li\">No data available.</li>";  ?>
    </ul>
