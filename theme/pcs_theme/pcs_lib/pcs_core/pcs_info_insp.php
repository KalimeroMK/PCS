<?php 
	if(!G5_IS_MOBILE&&$wr_id==1) {
		...
		else {echo '<font size = 5>Only <Strong>Authorized Member</strong> can check Inspection status.</font>';}
	}
	if(!G5_IS_MOBILE&&$wr_id==2) {
		...
		else {echo '<font size = 5>Only <Strong>Authorized Member</strong> can check Spool status.</font>';}
	}
