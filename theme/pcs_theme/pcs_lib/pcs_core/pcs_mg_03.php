...
if (!empty($_POST['pkg_select'])) {
    ...
    switch ($pkg_seq) {
        case 0 :
            ...
            break;
        case 1 :
            $seq = "B.review <> '0000-00-00' AND ";
            break;
        case 2 :
            $seq = "B.line_chk <> '0000-00-00' AND ";
            break;
        case 3 :
            $seq = "B.punch_A <> '0000-00-00' AND ";
            break;
        case 4 :
            $seq = "B.h_test <> '0000-00-00' AND ";
            break;
        default :
            break;
    }
    ...
    while ($sql_pkg_arr = sql_fetch_array($sql_pkg)) {
        ...
        for ($i = 0; $i < count($sql_field_array) - 1; $i++) {
            echo '<td class="jnt_td">' . $sql_pkg_arr[$sql_field_array[$i]] . '</td>';
        }
        echo '<td class="jnt_td">';
        if ($sql_pkg_arr[last_chk] != '0000-00-00') {
            echo $sql_pkg_arr['last_chk'];
        } else {
            echo 'Not yet';
        }
        echo '</td>
    ...
    <table class="main">
        ...
        for ($l = 0; $l < $cnt_agug; $l++) {
            ...
            for ($k = 0; $k < $cnt_unit; $k++) {
                ...
                for ($j = 0; $j < $cnt_type; $j++) {
                    ...
                    for ($i = 0; $i < $cnt_stat; $i++) {
                        ...
                        if ($i !== 0) {
                            $query_pkg .= ' AND ' . $pkg_stat[$i] . ' != "0000-00-00"  AND ' . $pkg_stat[$i + 1] . ' = "0000-00-00" ';
                        }
                    ...
                    <td class="main_td"><?php if ($pkg_qty_ag[$l][$k][$j][0] == 0) {
                            echo 'N/A';
                        } else {
                            echo sprintf("%2.1f", $pkg_qty_ag[$l][$k][$j][4] / $pkg_qty_ag[$l][$k][$j][0] * 100) . " %";
                        } ?></td>
                    </tr>
                ...
                <tr>
                    ...
                    for ($i = 0; $i < $cnt_stat; $i++) {
                        ...
                        <td class="main_td td_total"><?php if ($sum_unit[$l][$k][$i] == 0) {
                                echo '-';
                            } else {
                                echo $sum_unit[$l][$k][$i];
                            } ?></td>
                    ...
                    <td class="main_td td_total"><?php if ($sum_unit[$l][$k][0] == 0) {
                            echo 'N/A';
                        } else {
                            echo sprintf("%2.1f", $sum_unit[$l][$k][4] / $sum_unit[$l][$k][0] * 100) . " %";
                        } ?></td>
                </tr>
            ...
            <tr>
                ...
                for ($i = 0; $i < $cnt_stat; $i++) {
                    ...
                    <td class="main_td td_S_total">    <?php if ($sum_ag_ug[$l][$i] == 0) {
                            echo '-';
                        } else {
                            echo $sum_ag_ug[$l][$i];
                        } ?></td>
                ...
                <td class="main_td td_S_total">    <?php if ($sum_ag_ug[$l][0] == 0) {
                        echo 'N/A';
                    } else {
                        echo sprintf("%2.1f", $sum_ag_ug[$l][4] / $sum_ag_ug[$l][0] * 100) . " %";
                    } ?></td>
            </tr>
        ...
        <tr>
            ...
            for ($i = 0; $i < $cnt_stat; $i++) {
                ...
                <td class="main_td td_G_total">    <?php if ($sum_total[$i] == 0) {
                        echo '-';
                    } else {
                        echo $sum_total[$i];
                    } ?></td>
            ...
            <td class="main_td td_G_total"><?php if ($sum_total[0] == 0) {
                    echo 'N/A';
                } else {
                    echo sprintf("%2.1f", $sum_total[4] / $sum_total[0] * 100) . " %";
                } ?></td>
        </tr>
        </tbody>
    </table>
