<?php 
	if(!G5_IS_MOBILE&&$wr_id==1) {
		...
		if($_POST['btn_check']) 	{include_once (PCS_LIB.'/pcs_info_insp_ilist.php');}
	...
	if(!G5_IS_MOBILE&&$wr_id==2) {
		...
		if($_POST['btn_check']) 	{include_once (PCS_LIB.'/pcs_info_insp_slist.php');}
	...
	if(!G5_IS_MOBILE&&$wr_id==3) {
		...
		if($_POST['btn_check']) 	{include_once (PCS_LIB.'/pcs_info_insp_tplist.php');}
