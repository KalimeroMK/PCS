    ...
    <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php"
        ...
        <div id="bo_btn_top">
            ...
            <ul class="btn_bo_user">
                <?php if ($admin_href) { ?>
                    <li><a href="<?php echo $admin_href ?>" class="btn_admin btn" title="Admin"><i
                                class="fa fa-cog fa-spin fa-fw"></i><span class="sound_only">Admin</span></a>
                    </li><?php } ?>
                <?php if ($rss_href) { ?>
                    <li><a href="<?php echo $rss_href ?>" class="btn_b01 btn" title="RSS"><i class="fa fa-rss"
                                                                                             aria-hidden="true"></i><span
                                class="sound_only">RSS</span></a></li><?php } ?>
                <li>
                    <button type="button" class="btn_bo_sch btn_b01 btn" title="Board Search"><i class="fa fa-search"
                                                                                                 aria-hidden="true"></i><span
                ...
                <?php if ($is_admin == 'super' || $is_auth) { ?>
                    <li>
                        <button type="button" class="btn_more_opt is_list_btn btn_b01 btn" title="Board List Options"><i
                                    class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">Board List Options</span>
                        </button>
                        <?php if ($is_checkbox) { ?>
                            <ul class="more_opt is_list_btn">
                                <li>
                                    <button type="submit" name="btn_submit" value="Delete Selected"
                                ...
                                <li>
                                    <button type="submit" name="btn_submit" value="Copy Selected"
                                ...
                                <li>
                                    <button type="submit" name="btn_submit" value="Move Selected"
                                            onclick="document.pressed=this.value"><i class="fa fa-arrows"
                                                                                     aria-hidden="true"></i> Move
                                        Selected
                                    </button>
                                </li>
                            </ul>
        ...
        <ul id="gall_ul" class="gall_row">
                        ...
                        <div class="gall_con">
                            ...
                            <div class="gall_text_href">
                                ...
                                <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                                    ...
                                    ?>
                                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">Comments</span>
                                        <span class="cnt_cmt"><?php echo $list[$i]['wr_comment']; ?></span><span
                                                class="sound_only"> posts</span><?php } ?>
                                </a>
                            ...
                            <div class="gall_info">
                                ...
                                <span class="gall_date"><span class="sound_only">Date </span><i class="fa fa-clock-o"
                                                                                                aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></span>
                                <span class="gall_view"><span class="sound_only">Views </span><i class="fa fa-eye"
                                                                                                 aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></span>
                            </div>
                            <div class="gall_option">
                                <?php if ($is_good) { ?><span class="sound_only">Like</span><strong><i
                                        class="fa fa-thumbs-o-up"
                                        aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong><?php } ?>
                                <?php if ($is_nogood) { ?><span class="sound_only">Dislike</span><strong><i
                                        class="fa fa-thumbs-o-down"
                                        aria-hidden="true"></i> <?php echo $list[$i]['wr_nogood'] ?></strong><?php } ?>
                            </div>
                        </div>
                    </div>
                </li>
            <?php } ?>
            <?php if (count($list) == 0) {
                echo "<li class=\"empty_list\">No posts available.</li>";
            } ?>
        </ul>
                    ...
                    <ul class="btn_bo_user">
                        ...
                        <?php if ($rss_href) { ?>
                            <li><a href="<?php echo $rss_href ?>" class="btn_b01 btn" title="RSS"><i class="fa fa-rss"
                                        ...
                                        class="sound_only">RSS</span></a></li><?php } ?>
                        <?php if ($write_href) { ?>
                            <li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="Write"><i
            ...
            <form name="fsearch" method="get">
                ...
                <div class="sch_bar">
                    <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx"
                           class="sch_input" size="25" maxlength="20" placeholder="Please enter a search term">
                    <button type="submit" value="Search" class="sch_btn"><i class="fa fa-search" aria-hidden="true"></i><span
