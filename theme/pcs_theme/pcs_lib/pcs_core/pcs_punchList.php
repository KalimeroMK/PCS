...
<td class="jnt_td" style="height:45px; width:69%" colspan="3"><?php echo $sql_pkg_Pchk_arr['dwg_no']; ?></td>
<td class="main_td">
...
<?php
	if($sql_pkg_Pchk_arr['punch_desc']){ echo $sql_pkg_Pchk_arr['punch_desc'];}
	else { echo '<p style="text-align:center;font-size:25px;"><font color = red><b> No description </b></font></p>';}
?>
</td>
</tr>
<tr>
