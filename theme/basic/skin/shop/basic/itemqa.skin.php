...
<section id="sit_qa_list">
    ...
    for ($i = 0; $row = sql_fetch_array($result); $i++) {
        ...
        <li class="sit_qa_li">
            <button type="button" class="sit_qa_li_title"><span
                        class="<?php echo $iq_style; ?>"><?php echo $iq_stats; ?></span><?php echo $iq_subject; ?>
            </button>
            <dl class="sit_qa_dl">
                <dt>작성자/작성일</dt>
                <dd><?php echo $iq_name; ?><span class="st_bg"></span><i class="fa fa-clock-o"
                                                                         aria-hidden="true"></i> <?php echo $iq_time; ?>
                </dd>
            </dl>
            ...
            <div id="sit_qa_con_<?php echo $i; ?>" class="sit_qa_con">
                ...
                <?php if ($is_admin || ($row['mb_id'] == $member['mb_id'] && !$is_answer)) { ?>
                    <div class="sit_qa_cmd">
                        <a href="<?php echo $itemqa_form . "&amp;iq_id={$row['iq_id']}&amp;w=u"; ?>"
                           class="itemqa_form btn01" onclick="return false;">수정</a>
                        <a href="<?php echo $itemqa_formupdate . "&amp;iq_id={$row['iq_id']}&amp;w=d&amp;hash={$hash}"; ?>"
                           class="itemqa_delete btn01">삭제</a>
                    </div>
                <?php } ?>
            </div>
        </li>
