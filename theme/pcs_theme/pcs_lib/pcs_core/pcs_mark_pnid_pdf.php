        ...
        <div style='max-width:350px; position: absolute; top: 10px; right: 10px ; height:98.5%;'>
            <div style='width:99%; height:250px; border:1px solid red;font-size:25px;'>
                ...
                <form method="post" id='frm1'>
                    ...
                    <p align="center"><input type="submit" id="nClear" name="nClear" value="Mapping finish"
                ...
                <input type='radio' name='mark_type' id='rad_line' style="height:25px; width: 25px;" value='line'
                       checked>Line &nbsp; &nbsp;
                ...
                <input type='text' name='text_pkg' id='text_pkg'
                       style="height:30px; width: 150px; font-size:18px; padding:5px;" disabled>
                ...
                <p align="center"><input type='text' name='new_pkg' id='new_pkg'
                                         style="height:50px; width: 300px; font-size:18px; padding:5px;"
                                         onchange='addRowInTable()'></p>
            </div>

            <div style='overflow:scroll;width:99%; height:55%; border:1px solid yellow;'>

                <table id='jnt_table'
                       style="font-size:12px; border-width: 1px 1px 0px 0px; border-style: solid solid none none;"
                       width='100%' border="0" cellspacing="0" cellpadding="0">
                    <caption><span style="font-size: 20px;"> PACKAGE List </span></caption>
                    <tbody>
                    <tr style="height: 30px; background-color: aquamarine;">
                        <td style="border-width: 0px 0px 1px 1px; border-style: none none solid solid; width: 12%"><p
                                    align="center">No</p></td>
                        <td style="border-width: 0px 0px 1px 1px; border-style: none none solid solid; width: 70%"><p
                                    align="center">PACKAGE</p></td>
                        <td style="border-width: 0px 0px 1px 1px; border-style: none none solid solid; width: 18%"><p
                                    align="center">Color</p></td>
                    </tr>

                    <?php $pkgqty = 0;
                    foreach ($pkg_array as $pkg_order) {
                        if (strpos($pnid_coor_info, $pkg_order)) {
                            $trcolor = true;
                        }
                        ?>
                        <tr style="height: 30px;">
                            <td style="border-width: 0px 0px 1px 1px; border-style: none none solid solid; width: 12%"
                                onclick="return erasepkg('<?php echo $pkg_order; ?>')"><p
                                        align="center"><?php echo ++$pkgqty; ?></p></td>
                            <td style="border-width: 0px 0px 1px 1px; border-style: none none solid solid; width: 70%">
                                <p align="left">
                                    <input type='radio' name='marked_pkg' style='height:25px; width: 25px;'
                                           value='<?php echo $pkg_order; ?>'
                                           onclick="return filltext()"><?php echo $pkg_order; ?></td>
                            <td style="border-width: 0px 0px 1px 1px; border-style: none none solid solid; width: 18%">
                                <p align="center">
                                    <select id='<?php echo $pkg_order; ?>'
                                            style='WIDTH: 95%; height: 30px; font-size:15px;'
                                            onchange='return cngcolor()'>
                                        <?php for ($i = 0; $i < $color_qty; $i++) { ?>
                                            <option value='<?php echo $i; ?>'
                                                    style='background-color: <?php echo $products[$i]; ?>;'><?php echo $i; ?></option>
                                        <?php } ?>
                                    </select>
...
//			ini_img.src = document.getElementById("cv").toDataURL("image/png");
        ...
        function mRelease(evt, currentObj) {
            if (!document.getElementById('text_pkg').value) {
        ...
        function drawLine(xf, yf, xt, yt, mColor) {
            if (mColor) {
                context.strokeStyle = color_arr[mColor];
            } else {
