    ...
    <ul id="gnb_1dul">
        ...
        <li class="gnb_1dli" style="z-index:<?php echo $gnb_zindex; ?>">
            <a href="<?php echo $row['url']; ?>"
               class="gnb_1da"><?php echo $row['ca_name']; ?><?php if ($count !== 0) echo '<i class="fa fa-angle-right" aria-hidden="true"></i>'; ?></a>
            <?php
            $j = 0;
            foreach ($cate1 as $key => $cate2) {
                ...
                ?>
                <li class="gnb_2dli"><a href="<?php echo $row2['url']; ?>"
                                        class="gnb_2da"><?php echo $row2['ca_name']; ?></a></li>
                <?php $j++;
            }   //end for
            if ($j > 0) echo '</ul>';
            ?>
