...
class PHPExcel_Calculation
{
     ...
     * @access    private
     */
    private static ?\PHPExcel_Calculation $instance = null;
     ...
     * @access    private
     */
    private static array $binaryOperators = array(
        '+' => true,    '-' => true,    '*' => true,    '/' => true,
        '^' => true,    '&' => true,    '>' => true,    '<' => true,
        '=' => true,    '>=' => true,    '<=' => true,    '<>' => true,
        '|' => true,    ':' => true
     ...
     *
     */
    private static array $validLocaleLanguages = array(
    ...
    private static array $localeFunctions = array();
     ...
     *
     */
    private static array $excelConstants = array(
        'TRUE'  => true,
        'FALSE' => false,
        'NULL'  => null
    );
    ...
    private static array $controlFunctions = array(
        'MKMATRIX' => array(
            'argumentCount' => '*',
     ...
     */
    public function setCalculationCacheEnabled($pValue = true): void
    {
     ...
     */
    public function setLocale($locale = 'en_us'): bool
    {
                ...
                if (file_exists($configFile)) {
                    ...
                    foreach ($localeSettings as $localeSetting) {
                        ...
                        if (strpos($localeSetting, '=') !== false) {
                            ...
                            if ($settingName === 'ARGUMENTSEPARATOR') {
    ...
    public static function translateSeparator($fromSeparator, string $toSeparator, $formula, &$inBraces)
    {
    ...
    public function calculate(PHPExcel_Cell $pCell = null)
    {
        try {
            ...
            throw new PHPExcel_Calculation_Exception($e->getMessage(), $e->getCode(), $e);
        }
    }
    ...
    public function getValueFromCache($cellReference, &$cellValue): bool
    {
     ...
     *                                            2 = extend to fit
     */
    private static function checkMatrixOperands(&$operand1, &$operand2, int $resize = 1): array
    {
     ...
     */
    private static function getMatrixDimensions(&$matrix): array
    {
        $matrixRows = count($matrix);
        $matrixColumns = 0;
        foreach ($matrix as $rowKey => $rowValue) {
            $matrixColumns = max(count($rowValue), $matrixColumns);
            $matrix[$rowKey] = is_array($rowValue) ? array_values($rowValue) : array($rowValue);
        }
    ...
    private static array $operatorAssociativity    = array(
        '^' => 0,                                                            //    Exponentiation
    ...
    private static array $comparisonOperators    = array('>' => true, '<' => true, '=' => true, '>=' => true, '<=' => true, '<>' => true);

    //    Operator Precedence
    //    This list includes all valid operators, whether binary (including boolean) or unary (such as %)
    //    Array key is the operator, the value is its precedence
    private static array $operatorPrecedence    = array(
        ':' => 8,                                                                //    Range
        '|' => 7,                                                                //    Intersect
        '~' => 6,                                                                //    Negation
        '%' => 5,                                                                //    Percentage
...
//        }
    ...
    private function executeBinaryComparisonOperation($cellID, $operand1, $operand2, $operation, &$stack, bool $recursingArrays = false): bool
    {
        ...
        switch ($operation) {
            //    Greater than
            case '>':
                $result = $useLowercaseFirstComparison ? $this->strcmpLowercaseFirst($operand1, $operand2) > 0 : $operand1 > $operand2;
                break;
            //    Less than
            case '<':
                $result = $useLowercaseFirstComparison ? $this->strcmpLowercaseFirst($operand1, $operand2) < 0 : $operand1 < $operand2;
     ...
     */
    private function strcmpLowercaseFirst($str1, $str2): int
    {
    ...
    private function executeNumericBinaryOperation($operand1, $operand2, $operation, string $matrixFunction, &$stack): bool
    {
        ...
        } elseif ((PHPExcel_Calculation_Functions::getCompatibilityMode() != PHPExcel_Calculation_Functions::COMPATIBILITY_OPENOFFICE) &&
     ...
     * @return array<int|string, non-empty-array> Array of values in range if range contains more than one element. Otherwise, a single value is returned.
     * @throws    PHPExcel_Calculation_Exception
     */
    public function extractCellRange(&$pRange = 'A1', PHPExcel_Worksheet $pSheet = null, $resetLog = true): array
    {
        // Return value
        $returnValue = array ();
