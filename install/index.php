...
$title = G5_VERSION . " License Check 1/3";
...
if ($exists_data_dir && $write_data_dir) {
    ...
    <form action="./install_config.php" method="post" onsubmit="return frm_submit(this);">
        ...
        <div class="ins_inner">
            <p>
                <strong class="st_strong">Please carefully review the License contents.</strong><br>
            ...
            <div class="ins_ta ins_license">
                <textarea name="textarea" id="ins_license"
                          readonly><?php echo implode('', file('../LICENSE.txt')); ?></textarea>
            </div>
