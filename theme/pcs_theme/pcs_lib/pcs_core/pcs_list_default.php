            ...
            <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <td class="pcs_subject"
                    ...
                    <div class="bo_tit">
                        ...
                        <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><span class="cnt_cmt">+ <?php echo $list[$i]['wr_comment']; ?></span>
...
//			echo $query_time;
                        ...
                        <td class="pcs_td_spl"><?php if ($sql_eq_arr['dwg_1']) {
                                echo $sql_eq_arr['dwg_1'];
                            } else {
                                echo 'N/A';
                            } ?></td>
                        <td class="pcs_td_spl"><?php if ($sql_eq_arr['dwg_2']) {
                                echo $sql_eq_arr['dwg_2'];
                            } else {
                                echo 'N/A';
                            } ?></td>
                        <td class="pcs_td_spl"><?php if ($sql_eq_arr['dwg_3']) {
                                echo $sql_eq_arr['dwg_3'];
                            } else {
                                echo 'N/A';
                            } ?></td>
                        <td class="pcs_td_spl"><?php if ($sql_eq_arr['dwg_4']) {
                                echo $sql_eq_arr['dwg_4'];
                            } else {
                                echo 'N/A';
                            } ?></td>
                        <td class="pcs_td_spl"><?php if ($sql_eq_arr['dwg_5']) {
                                echo $sql_eq_arr['dwg_5'];
                            } else {
                                echo 'N/A';
                            } ?></td>
...
//			echo $query_time;
                        ...
                        <td class="pcs_td_spl">
                            ...
                            switch ($state) {
                                case 'On_going'        :
                                    echo '<font color = orange><strong>On welding</strong></font>';
                                    break;
                                case 'Finished'    :
                                    echo '<font color = green><strong>Finished</strong></font>';
                                    break;
                                default                :
                                    echo '<font color = red><strong>Not start</strong></font>';
                                    break;
                            }
                            ?>
                        </td>
                        ...
                        <td class="pcs_td_spl"><?php if ($lastdays) {
                                echo 'D +<b><font size = 4>' . $lastdays;
                            } ?></td>
                    ...
                    case 'iso'    :                    //	dwg_no 개시판에서만 도면 클릭 가능
                        ...
                        <td class="pcs_td_pkg">
                            <?php if ($member['mb_1']) {
                                echo '<a href = "javascript:document.shop' . $i . '.submit()" >' . $sql_dwg_arr['shop_dwg'] . '</a>';
                                viewPDF('shop' . $i, 'shop', $or_sub, $sql_dwg_arr['shop_dwg']);
                            } else {
                                echo $sql_dwg_arr['shop_dwg'];
                            } ?>
                        </td>
                        <td class="pcs_td_dwg">
                            <?php switch ($sql_dwg_arr['state']) {
                                case 'HOLD'    :
                                    echo '<font color = "blue"><b>' . $sql_dwg_arr['state'] . '</b></font>';
                                    break;
                                case 'DEL'    :
                                    echo '<font color = "red"><b>' . $sql_dwg_arr['state'] . '</b></font>';
                                    break;
                                default                :
                                    echo $sql_dwg_arr['state'];
                                    break;
                            }
                            ?>
                        </td>
                        <td class="pcs_td_pkg">
                            <?php if ($member['mb_1']) {
                                echo '<a href = "javascript:document.marked' . $i . '.submit()" >' . $state_info . '</a>';
                                viewPDF('marked' . $i, 'fab', $or_sub, $sql_dwg_arr['rev_no']);
                            } else {
                                echo $state_info;
                            } ?>
                        </td>
                    ...
                    case 'pnid'    :
                        ...
                        <td class="pcs_td_nor">
                            <?php switch ($sql_pnid_arr['unit']) {
                                case 'HOT'        :
                                    echo '<font color = red>HOT</font>';
                                    break;
                                case 'COLD'    :
                                    echo '<font color = blue><strong>COLD</strong></font>';
                                    break;
                                default            :
                                    echo $sql_pnid_arr['unit'];
                                    break;
                            }
                            ?>
                        </td>
                    ...
                    case 'plan'    :
                        ...
                        <td class="pcs_td_pkg"><a href='javascript:document.submit_for<?php echo $i; ?>.submit()'>
                                <b> <?php echo $sql_plan_arr['area']; ?>  </b> </a></td>
                        <form name='submit_for<?php echo $i; ?>' action="<?php echo PCS_WPV_URL; ?>/viewer.php"
                              method="post" target="<?php echo $or_sub; ?>" onSubmit="return doSumbit()">
                        ...
                        <td class="pcs_td_pkg"><?php if ($sql_plan_arr['tp_no'] != 'NO TP') {
                                echo substr_count($sql_plan_arr['tp_no'], ';') . ' ea';
                            } else {
                                echo 'NO TP';
                            } ?></td>
                    ...
                    case 'work'    :
                        ...
                        ?>
                        <td class="pcs_td_pkg"><a href='javascript:document.submit_for<?php echo $i; ?>.submit()'>
                                <b> <?php echo $sql_work_arr['unit']; ?>  </b> </a></td>
                        <td class="pcs_td_nor"><?php if (file_exists($work_file)) {
                                echo date("Y-m-d", filemtime($work_file));
                            } else {
                                echo '-';
                            } ?></td>
                        <form name='submit_for<?php echo $i; ?>' action="<?php echo PCS_WPV_URL; ?>/viewer.php"
...
//				$ran = mt_rand(1, 10000);
                        ...
                        <td class="pcs_td_nor"><a href='javascript:document.submit_forplan<?php echo $i; ?>.submit()'>
                                <b> <?php echo $sql_tp_arr['plan_no']; ?>  </b> </a></td>
                        <form name='submit_forplan<?php echo $i; ?>' action="<?php echo PCS_WPV_URL; ?>/viewer.php"
                              method="post" target="<?php echo $or_sub . 'plan'; ?>" onSubmit="return doSumbit()">
                            <input type="hidden" name="folder" value="plan/piping">
                        ...
                        <td class="pcs_td_nor"><a href='javascript:document.submit_forpnid<?php echo $i; ?>.submit()'>
                                <b> <?php echo $sql_tp_arr['pnid_no']; ?>  </b> </a></td>
                        <form name='submit_forpnid<?php echo $i; ?>' action="<?php echo PCS_WPV_URL; ?>/viewer.php"
                              method="post" target="<?php echo $or_sub . 'pnid'; ?>" onSubmit="return doSumbit()">
                        ...
                        <td class="pcs_td_nor">
                            <?php
                            if (($sql_tp_pt_arr['tp_photo1'] ?? null)) {
                                photo_thumb('tp', $sql_tp_pt_arr['tp_photo1'], 'photo1', 80, 'thumb_');
                            }
                            ?>
                        </td>
                        <td class="pcs_td_nor">
                            <?php
                            if (($sql_tp_pt_arr['tp_photo2'] ?? null)) {
                                photo_thumb('tp', $sql_tp_pt_arr['tp_photo2'], 'photo1', 80, 'thumb_');
                            }
                            ?>
                        </td>
                        <td class="pcs_td_nor">
                            <?php
                            if (($sql_tp_pt_arr['tp_photo3'] ?? null)) {
                                photo_thumb('tp', $sql_tp_pt_arr['tp_photo3'], 'photo1', 80, 'thumb_');
                            }
                            ?>
                        </td>
        ...
        <?php } ?>
        <?php if (count($list) == 0) {
            echo '<tr><td colspan="' . $colspan . '" class="empty_table">No item.</td></tr>';
        } ?>
        </tbody>
    </table>
</div>
