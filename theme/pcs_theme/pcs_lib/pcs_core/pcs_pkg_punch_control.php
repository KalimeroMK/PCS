...
if ($_POST['mode'] == 'issue') {
    ...
    if ($pc_no * 1 < 10) {
        ...
        $punchFile = $pkg_no . '_' . $pc_no;
    }

    $pncURL = PCS_PKG_URL . '/' . $pkg_no . '/' . $punchFile;

    if ($member['mb_7'] < 2 && $member['mb_nick'] != $sql_pnc_up_arr['issued_by'] && substr($sql_pnc_up_arr['pcs_vi_rlt_by'], 0, 10) != G5_TIME_YMD) {
        $rmv_ok = false;
    } else {
        $rmv_ok = true;
    }
        ...
        <div style="overflow:hidden;height:auto;">
                ...
                <table class="main" style="width:100%">
                    ...
                    <tr>
                        <td class="main_td" style="height:60px; font-size:25px;">
                            <?php
                            if ($_POST['mode'] == 'issue') {
                                echo '<input type="file" name="myFile1" id="pcs_thumb1" accept="image/*" style="width:100%" />';
                            }
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="main_td" style="height:295px"><img id='pcs_prev1' width='350px'
                                                                      src='<?php if ($sql_pnc_up_arr['issued_by']) {
                                                                          echo $pncURL . '_BF.jpg';
            ...
            <div style="width:50%;float:left; padding:10px;">
                ...
                <table class="main" style="width:100%">
                    ...
                    <tbody>
                    <tr>
                        <td class="main_td td_sub" style="width:20%; height:60px; font-size:25px;" colspan="1">
                            Drawing
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="main_td" colspan="3"
                            style="text-align:left;font-size:20px;padding:0px 0px 0px 15px;">
                            <?php
                            if ($_POST['mode'] == 'issue' || $_POST['mode'] == 'u_desc') {
                                echo '<input type="text" name="punch_des" autocomplete="off" style="padding:0px 0px 0px 15px; text-align:left;width:98%;height:50px;font-size:20px;border:none;" onchange="reveal();" value="' . $sql_pnc_up_arr['punch_desc'] . '">';
                            } else {
                                echo $sql_pnc_up_arr['punch_desc'];
                            }
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="main_td">
                            ...
                            if ($_POST['mode'] == 'issue') {
                                ?>
                                <select name="punch_cat" id="punch_cat"
                                        style="padding:0px 0px 0px 15px; text-align:left;width:50%;height:70px;font-size:40px;border:none;">
                    ...
                    <tr>
                        ...
                        <td class="main_td"
                            style="width:20%; height:80px; font-size:25px;"> <?php if ($sql_pnc_up_arr['issued_by']) {
                                echo $sql_pnc_up_arr['issued_date'];
                            } ?></td>
                        <td class="main_td td_sub" style="width:20%; height:80px; font-size:25px;"> Issued by</td>
                        <td class="main_td"
                            style="width:20%; height:80px; font-size:25px;"> <?php echo $sql_pnc_up_arr['issued_by']; ?></td>
                    </tr>
                    <tr>
                        <td class="main_td td_sub" style="width:20%; height:80px; font-size:25px;"> Clear Date</td>
                        <td class="main_td"
                            style="width:20%; height:80px; font-size:25px;"> <?php if ($sql_pnc_up_arr['cleared_by']) {
                                echo $sql_pnc_up_arr['cleared_date'];
                            } ?></td>
                        <td class="main_td td_sub" style="width:20%; height:80px; font-size:25px;"> Cleared by</td>
                        <td class="main_td"
                            style="width:20%; height:80px; font-size:25px;"> <?php echo $sql_pnc_up_arr['cleared_by']; ?></td>
                    </tr>
                    <tr>
                        <td class="main_td" style="height:60px" colspan="2"><a id="sbm"
                                                                               href='javascript:document.punch.submit()' <?php if ($_POST['mode'] != 'remove') {
                                echo 'hidden';
                            } ?>>
                                <?php
                                if ($member['mb_7']) {
                        ...
                        <td class="main_td" style="height:60px;" colspan="2"><a
                                    href="<?php echo G5_BBS_URL . '/board.php?bo_table=' . $bo_table . '&wr_id=' . $wr_id; ?>"><font
                                        color=red><b> Cancle </b></font></a></td>
                    </tr>
                ...
                <table class="main" style="width:100%">
                    ...
                    <tr>
                        <td class="main_td" style="height:60px; font-size:25px;">
                            <?php
                            if ($_POST['mode'] == 'clear') {
                                echo '<input type="file" name="myFile2" id="pcs_thumb2" accept="image/*" style="width:100%" />';
                            }
                            ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="main_td" style="height:295px"><img id='pcs_prev2' width='350px'
                                                                      src='<?php if ($sql_pnc_up_arr['cleared_by']) {
                                                                          echo $pncURL . '_AF.jpg';
                                                                      } ?>' alt='thumbnail image'></td>
                    </tr>
                    <tr>
        ...
        <table class="main" style="width:100%">
            ...
            <tr>
                ...
                <td class="jnt_td" colspan="3" style="text-align:left;font-size:20px;padding:0px 0px 0px 15px;">
                    <?php
                    if ($_POST['mode'] == 'issue') {
                        echo '<input type="text" name="punch_des" autocomplete="off" style="padding:0px 0px 0px 15px; text-align:left;width:98%;height:50px;font-size:20px;border:none;">';
                    } else {
                        echo $sql_pnc_up_arr['punch_desc'];
                    }
                    ?>
            ...
            <tr>
                ...
                <td class="jnt_td">
                    ...
                    if ($_POST['mode'] == 'issue') {
                        ?>
                        <select name="punch_cat" id="punch_cat"
                                style="padding:0px 0px 0px 15px; text-align:left;height:50px;font-size:30px;border:none;">
            ...
            <tr>
                <td class="main_td" style="height:300px" colspan="4">
                    <?php
                    if ($_POST['mode'] == 'issue' || $_POST['mode'] == 'remove') {
                        echo '<img id="pcs_prev1" width="300px" src="' . $pncURL . '_BF.jpg" alt="thumbnail image">';
                    }
                    if ($_POST['mode'] == 'clear') {
                        echo '<img id="pcs_prev2" width="300px" src="' . $pncURL . '_AF.jpg" alt="thumbnail image">';
                    }
                    ?>
                </td>
            </tr>
            <tr>
                <td class="jnt_td" style="width:50%; height:60px" colspan="2"><a id="sbm"
                                                                                 href='javascript:document.punch.submit()' <?php if ($_POST['mode'] != 'remove') {
                        echo 'hidden';
                    } ?>>
                        <?php
                ...
                <td class="jnt_td" style="width:50%; height:60px;" colspan="2"><a
                            href="<?php echo G5_BBS_URL . '/board.php?bo_table=' . $bo_table . '&wr_id=' . $wr_id; ?>"><font
                                color=red><b> Cancle </b></font></a></td>
            </tr>
