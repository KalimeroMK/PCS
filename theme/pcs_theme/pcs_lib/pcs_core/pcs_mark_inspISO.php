...
////////////////도면시작
    ...
    for ($j = 0; $j < $temp_j; $j++) {
        PDFjointmarking($pcs_markedPDF, $sql_total_pkg_array['dwg_no'], $jointcoor[$j], $_POST['chk_by'][$sql_total_pkg_array['dwg_no']], $_POST['curr_jnt'][$sql_total_pkg_array['dwg_no']]);
    }
