...
<div style="font-weight: bold; font-size: 20px; color: green; text-align:center;"><span id="outputData">SCAN QRcode</span></div>
  </div>
<script>
var lat = '';
var lon = '';
...
//		canvasElement.hidden = false;
		...
		canvasElement2.width = <?php if(G5_IS_MOBILE){echo 'document.body.clientWidth';} else { echo '800';} ?>;
