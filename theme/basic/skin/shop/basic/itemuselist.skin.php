        ...
        <li>
            <div class="sps_img">
                <div class="sps_img_inner">
                    ...
                    <button class="prd_detail"
                            data-url="<?php echo G5_SHOP_URL . '/largeimage.php?it_id=' . $row['it_id']; ?>"><i
                                class="fa fa-camera" aria-hidden="true"></i><span class="sound_only">상품 이미지보기</span>
                    </button>
                </div>
            </div>
            ...
            <div class="sps_section">
                ...
                <span><img src="<?php echo G5_URL; ?>/shop/img/s_star<?php echo $star; ?>.png"
                           alt="별<?php echo $star; ?>개" width="80"></span>
                ...
                <div class="sps_con_btn">
                    <dl class="sps_dl">
                        ...
                        <dd><i class="fa fa-clock-o"
                               aria-hidden="true"></i> <?php echo substr($row['is_time'], 0, 10); ?></dd>
                    </dl>
                        ...
                        <div class="review_detail_in">
                            ...
                            <div class="review_cnt">
                                <div class="review_tp_cnt">
                                    ...
                                    <dl class="sps_dl">
                                        <dt class="sound_only">작성자</dt>
                                        <dd><i class="fa fa-user" aria-hidden="true"></i> <?php echo $row['is_name']; ?>
                                        </dd>
                                        <dt class="sound_only">작성일</dt>
                                        <dd><i class="fa fa-clock-o"
                                               aria-hidden="true"></i> <?php echo substr($row['is_time'], 0, 10); ?>
                                        </dd>
                                    </dl>
                                </div>
                                <div class="review_summ">
                                    ...
                                    <span class="sound_only">평가점수</span><img
                                            src="<?php echo G5_URL; ?>/shop/img/s_star<?php echo $star; ?>.png"
                                            alt="별<?php echo $star; ?>개" width="80">
                                </div>
                                            ...
                                            <section>
                                                ...
                                                <div class="sps_dl">
                                                    <i class="fa fa-clock-o"
                                                       aria-hidden="true"></i> <?php echo $row['is_reply_name']; ?>
                                                </div>
                            ...
                            <button class="rd_cls"><span class="sound_only">후기 상세보기 팝업 닫기</span><i class="fa fa-times"
                                                                                                   aria-hidden="true"></i>
                            </button>
                        </div>
                    </div>
