...
<table class="main" id="spec">
    ...
    <tbody>
    <td class="main_td td_sub" style="height:80px;" colspan="6"><a href='javascript:document.shopdwg.submit()'> <b>
                DRAWING INFORMATION </b> </a></td>
    ...
    <tr>
        ...
        <td class="main_td" colspan="2">
            ...
            <form name='numbering_form' action="<?php echo PCS_CORE_URL; ?>/pcs_mark_joint_pdf.php" method="post"
        ...
        <td class="main_td" style='background-color: #DCFF99;'>
            <a href='javascript:document.submit_for_marked<?php echo $sql_dwg_arr['rev_no']; ?>.submit()'><b>
                    Rev_<?php echo $sql_dwg_arr['rev_no']; ?> </b></a>
        ...
        <td class="main_td">
            ...
            for ($j = 0; $j < $r_number; $j++) { ?>
                <a href='javascript:document.submit_for_old<?php echo $j; ?>.submit()'>
                    R_<?php echo $rev_array[$j]; ?> </a>
...
<table class="main" id="joint">
    ...
    sql_query($query_view_dwg_drop);
        ...
        <table class="main">
            ...
            <tbody>
            <tr>
                <td class="main_td td_sub" style="background-color: orange;font-size:18px;" colspan="2"><a
                            href='javascript:document.submit_for_marked.submit()'><?php echo $view['wr_subject']; ?></a>
