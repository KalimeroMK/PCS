...
if ($_POST['p_page'] == 'p_upda') {
    ...
    if ($_POST['s_no'] * 1 < 10) {
        ...
        $punchFile = $_POST['pkg_no'] . '_' . $_POST['s_no'];
    }
    ...
    if ($_POST['punch'] == 'remove') {
        $punch_sql = 'DELETE FROM ' . G5_TABLE_PREFIX . 'pcs_info_punch	WHERE pkg_no = "' . $_POST['pkg_no'] . '" AND s_no = "' . $_POST['s_no'] . '"';
        sql_query($punch_sql);
