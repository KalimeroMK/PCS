        ...
        <li>
            ...
            <section class="sqa_section">
                ...
                <dl class="sqa_dl">
                    ...
                    <dd><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo substr($row['iq_time'], 0, 10); ?>
                    </dd>
                </dl>
                ...
                <div class="sqa_con_btn">
                    <button class="sqa_con_<?php echo $i; ?>">내용보기 <i class="fa fa-caret-down" aria-hidden="true"></i>
                    </button>
                </div>
            </section>
