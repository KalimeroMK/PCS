        ...
        <div style='background-color:white; padding:10px; width:57%; float: left;'>
            <table class="main">
                ...
                <form name="zipdata" id="zipdata" method="post" enctype="multipart/form-data">
                    ...
                    echo $pcs_typ; ?>">
                    <tr>
                        <td class="main_td" style="text-align:left; padding:10px;"><input type="file" name="zip_file"
                                                                                          id='zip_file'
                                                                                          style='width:100%'
            ...
            <div style='background-color:white; padding:10px; width:43%; float: right;'>
                <table class="main">
                    ...
                    <form name="pdffiles" id="pdffiles" method="post" enctype="multipart/form-data">
                        ...
                        echo $pcs_typ; ?>">
                        <tr>
                            <td class="main_td" style="text-align:left; padding:10px;"><input type="file"
                                                                                              name="pdf_file[]"
                                                                                              id='pdf_file'
                                                                                              style='width:100%'
                        ...
                        <tr>
                            <td class="main_td" style="padding:10px;"><input type="submit" value=" PDF upload "
                                                                             accesskey="s"
                                                                             class="btn_submit"
