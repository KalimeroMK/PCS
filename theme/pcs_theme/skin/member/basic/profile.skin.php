...
<div id="profile" class="new_win">
    <h1 id="win_title">Profile of <?php echo $mb_nick ?></h1>
    ...
    <div class="tbl_head02 tbl_wrap new_win_con">
        ...
        <tbody>
        <tr>
            <th scope="row"><i class="fa fa-star-o" aria-hidden="true"></i>  Member Level</th>
        ...
        <tr>
            <th scope="row"><i class="fa fa-clock-o" aria-hidden="true"></i> Registration Date</th>
            <td><?php echo ($member['mb_level'] >= $mb['mb_level']) ?  substr($mb['mb_datetime'],0,10) ." (".number_format($mb_reg_after)." days)" : "Unknown";  ?></td>
            <th scope="row"><i class="fa fa-clock-o" aria-hidden="true"></i> Last Login</th>
