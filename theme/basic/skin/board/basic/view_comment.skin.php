        ...
        <article id="c_<?php echo $comment_id ?>"
            ...
            <div class="cm_wrap">
                ...
                <header style="z-index:<?php echo $cmt_sv; ?>">
                    <h2><?php echo get_text($list[$i]['wr_name']); ?>님의 <?php if ($cmt_depth !== 0) { ?><span
                ...
                <div class="cmt_contents">
                    ...
                    <?php if ($is_comment_reply_edit !== 0) {
                        if ($w == 'cu') {
            ...
            <?php if ($is_comment_reply_edit !== 0) { ?>
                <div class="bo_vl_opt">
                    <button type="button" class="btn_cm_opt btn_b01 btn"><i class="fa fa-ellipsis-v"
                    ...
                    <ul class="bo_vc_act">
                        ...
                        <?php if ($list[$i]['is_del']) { ?>
                            <li><a href="<?php echo $list[$i]['del_link']; ?>" onclick="return comment_delete();">삭제</a>
                            </li><?php } ?>
                    </ul>
                </div>
            <?php } ?>
