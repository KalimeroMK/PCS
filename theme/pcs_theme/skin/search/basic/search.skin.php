...
<form name="fsearch" onsubmit="return fsearch_submit(this);" method="get">
    ...
    <fieldset id="sch_res_detail">
        ...
        <select name="sfl" id="sfl">
            <option value="wr_subject||wr_content"<?php echo get_selected($_GET['sfl'], "wr_subject||wr_content") ?>>
                제목+내용
            </option>
    ...
    <section class="sch_res_list"><?php } ?>
        ...
        for ($idx = $table_index, $k = 0; $idx < count($search_table) && $k < $rows; $idx++) {
            ...
            <div class="search_board_result">
                <h2>
                    <a href="<?php echo get_pretty_url($search_table[$idx], '', $search_query); ?>"><?php echo $bo_subject[$idx] ?>
                        게시판 내 결과</a></h2>
                    ...
                    for ($i = 0; $i < count($list[$idx]) && $k < $rows; $i++, $k++) {
                        ...
                        <li>
                            <div class="sch_tit">
                                ...
                                <a href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>"
                                   target="_blank" class="pop_a"><i class="fa fa-window-restore" aria-hidden="true"></i><span
                                            class="sound_only">새창</span></a>
                            </div>
                            <p><?php echo $list[$idx][$i]['content'] ?></p>
                            <div class="sch_info">
                                <?php echo $list[$idx][$i]['name'] ?>
                                <span class="sch_datetime"><i class="fa fa-clock-o"
                                                              aria-hidden="true"></i> <?php echo $list[$idx][$i]['wr_datetime'] ?></span>
                            </div>
                        </li>
                    <?php } ?>
                </ul>
