    ...
    <table class="main">
        ...
        <tr>
            ...
            for ($i = 0; isset($table_field_array[$i]) && $table_field_array[$i]; $i++) {
                ...
                <td class="jnt_td jnt_th"
                    style="width: <?php echo $table_width_array[$i]; ?>px;"><?php echo $table_field_array[$i]; ?></td>
            ...
            for ($i = 0; isset($table_field_array[$i]) && $table_field_array[$i]; $i++) {
                switch ($i) {
                    ...
                    case 2 :
                        ...
                        <td class="jnt_td" style="width: <?php echo $table_width_array[$i]; ?>px;"><input type='text'
                                                                                                          name='<?php echo $mysql_field_array[$i]; ?>'
                    ...
                    case 7 :
                        ...
                        <td class="jnt_td"
                            style="width: <?php echo $table_width_array[$i]; ?>px;"><?php echo 'From : ' . $datxt1 . ' ~ To : ' . $datxt2; ?></td>
