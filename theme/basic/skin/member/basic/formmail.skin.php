            ...
            <ul>
                <?php if (!$is_member) { ?>
                    ...
                    <li>
                        ...
                        <input type="text" name="fmail" id="fmail" required class="frm_input full_input required"
                               placeholder="E-mail">
                    </li>
                <?php } ?>
                <li>
                ...
                <li class="formmail_flie">
                    <div class="file_wr">
                        <label for="file1" class="lb_icon"><i class="fa fa-download" aria-hidden="true"></i><span
                                    class="sound_only"> 첨부 파일 1</span></label>
                ...
                <li class="formmail_flie">
                    <div class="file_wr">
                        <label for="file2" class="lb_icon"><i class="fa fa-download" aria-hidden="true"></i><span
                                    class="sound_only"> 첨부 파일 2</span></label>
