...
<td class="jnt_td"><a href=<?php echo G5_URL.'/bbs/board.php?bo_table=tp&wr_id='.$sql_g5_spl_arr['wr_id']; ?> target='_self'> <font style='font-size:25px;'> <b> <?php echo $sql_insp_spl_arr['tp_no']; ?></b></font></a></td>
<td class="jnt_td"><?php if($sql_insp_spl_arr['tp_photo1_by']){echo $sql_insp_spl_arr['tp_photo1_by'].'<br>'.$sql_insp_spl_arr['tp_photo1_tm'];} ?></td>
<td class="jnt_td"><?php if($sql_insp_spl_arr['tp_photo1_by']){photo_thumb('tp', $sql_insp_spl_arr['tp_photo1'], '', 150);} ?></td>
<td class="jnt_td"><?php if($sql_insp_spl_arr['tp_photo2_by']){echo $sql_insp_spl_arr['tp_photo2_by'].'<br>'.$sql_insp_spl_arr['tp_photo2_tm'];} ?></td>
<td class="jnt_td"><?php if($sql_insp_spl_arr['tp_photo2_by']){photo_thumb('tp', $sql_insp_spl_arr['tp_photo2'], '', 150);} ?></td>
<td class="jnt_td"><?php if($sql_insp_spl_arr['tp_photo3_by']){echo $sql_insp_spl_arr['tp_photo3_by'].'<br>'.$sql_insp_spl_arr['tp_photo3_tm'];} ?></td>
<td class="jnt_td"><?php if($sql_insp_spl_arr['tp_photo3_by']){photo_thumb('tp', $sql_insp_spl_arr['tp_photo3'], '', 150);} ?></td>
</tr>
