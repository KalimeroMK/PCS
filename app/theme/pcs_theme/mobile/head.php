...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo PCS_CORE_URL ?>/pcs_logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
...
<?php if($member['mb_1']) { ?>
            ...
            ?>
                <li class="gnb_1dli">
                    <a href="<?php echo str_replace('http://127.0.0.1/demo',G5_URL,$row['me_link']); ?>" target="_<?php echo $row['me_target']; ?>" class="gnb_1da"><?php echo $row['me_name'] ?></a>
                    <?php
                    $k = 0;
