...
<tr>
<td class="main_td td_sub" style="height:80px;" colspan="6"> Tie-in Point <b><?php echo $view['wr_subject'];?></b> INFORMATION </td>
...
<td class="main_td" colspan="2"><a href='javascript:document.submit_forplan.submit()'> <b> <?php echo $sql_tp_arr['plan_no']; ?>  </b></a></td>
				<form name='submit_forplan' action="<?php echo PCS_WPV_URL; ?>/viewer.php" method="post" target="<?php echo $or_sub.'plan';?>" onSubmit="return doSumbit()"> 
...
<td class="main_td" colspan="2"><a href='javascript:document.submit_forpnid.submit()'> <b> <?php echo $sql_tp_arr['pnid_no']; ?>  </b></a></td>
				<form name='submit_forpnid' action="<?php echo PCS_WPV_URL; ?>/viewer.php" method="post" target="<?php echo $or_sub.'pnid';?>" onSubmit="return doSumbit()"> 
...
<tr>
<td class="main_td td_sub" style="height:60px;" colspan="4"><b><?php echo $view['wr_subject'];?></b></td>
	<form name='submit_for' action="<?php echo PCS_WPV_URL; ?>/viewer.php" method="post" target="<?php echo $view['wr_subject'];?>" onSubmit="return doSumbit()"> 
	<input type="hidden" name="folder" value="tp">
	<input type="hidden" name="file" value="<?php echo $view['wr_subject'];?>">
	<input type="hidden" name="rev" value="<?php echo $sql_tp_arr['rev_no'];?>">
...
<td class="main_td" colspan="3"><a href='javascript:document.submit_forplan.submit()'> <b> <?php echo $sql_tp_arr['plan_no']; ?>  </b></a></td>
				<form name='submit_forplan' action="<?php echo PCS_WPV_URL; ?>/viewer.php" method="post" target="<?php echo $or_sub.'plan';?>" onSubmit="return doSumbit()"> 
					<input type="hidden" name="folder" value="plan">
					<input type="hidden" name="file" value="<?php echo $sql_tp_arr['plan_no'];?>">
					<input type="hidden" name="rev" value="<?php echo $sql_tp_plan_arr['rev_no'];?>">
...
<td class="main_td" colspan="3"><a href='javascript:document.submit_forpnid.submit()'> <b> <?php echo $sql_tp_arr['pnid_no']; ?>  </b></a></td>
				<form name='submit_forpnid' action="<?php echo PCS_WPV_URL; ?>/viewer.php" method="post" target="<?php echo $or_sub.'pnid';?>" onSubmit="return doSumbit()"> 
					<input type="hidden" name="folder" value="pnid">
					<input type="hidden" name="file" value="<?php echo $sql_tp_arr['pnid_no'];?>">
					<input type="hidden" name="rev" value="<?php echo $sql_tp_pnid_arr['rev_no'];?>">
