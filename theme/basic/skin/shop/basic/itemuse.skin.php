...
<section id="sit_use_list">
    ...
    <div class="sit_use_top">
        ...
        <?php } ?>
        <div id="sit_use_wbtn">
            <a href="<?php echo $itemuse_form; ?>" class="btn02 itemuse_form">사용후기 쓰기<span
                        class="sound_only"> 새 창</span></a>
    ...
    for ($i = 0; $row = sql_fetch_array($result); $i++) {
        ...
        <li class="sit_use_li">
            ...
            <dl class="sit_use_dl">
                <dt>평점
                <dt>
                <dd class="sit_use_star"><img src="<?php echo G5_SHOP_URL; ?>/img/s_star<?php echo $is_star; ?>.png"
                                              alt="별<?php echo $is_star; ?>개" width="85"></dd>
                <dt></dt>
                <dd class="sit_use_tit"><?php echo $is_subject; ?></dd>
                <dt>작성자/작성일</dt>
                <dd><?php echo $is_name; ?><span class="st_bg"></span><i class="fa fa-clock-o"
                                                                         aria-hidden="true"></i> <?php echo $is_time; ?>
                </dd>
            </dl>
            <button type="button" class="sit_use_li_title">내용보기 <i class="fa fa-caret-down" aria-hidden="true"></i>
            </button>
            ...
            <div id="sit_use_con_<?php echo $i; ?>" class="sit_use_con">
                ...
                <?php if ($is_admin || $row['mb_id'] == $member['mb_id']) { ?>
                    <div class="sit_use_cmd">
                        <a href="<?php echo $itemuse_form . "&amp;is_id={$row['is_id']}&amp;w=u"; ?>"
                           class="itemuse_form btn01" onclick="return false;">수정</a>
                        <a href="<?php echo $itemuse_formupdate . "&amp;is_id={$row['is_id']}&amp;w=d&amp;hash={$hash}"; ?>"
                           class="itemuse_delete btn01">삭제</a>
                    </div>
                <?php } ?>
