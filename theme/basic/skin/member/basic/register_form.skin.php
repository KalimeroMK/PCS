                ...
                <ul>
                    <li>
                        ...
                        <input type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>"
                               ...
                               class="frm_input full_input <?php echo $required ?> <?php echo $readonly ?>"
                    ...
                    <li class="half_input left_input margin_input">
                        ...
                        <input type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?>
                               class="frm_input full_input <?php echo $required ?>" minlength="3" maxlength="20"
                               placeholder="비밀번호">
                    </li>
                ...
                <ul>
                    <li>
                        ...
                        if ($config['cf_cert_use'] && $member['mb_certify']) {
                            ...
                            ?>
                            <div id="msg_certify">
                                <strong><?php echo $mb_cert; ?> 본인확인</strong><?php if ($member['mb_adult']) { ?> 및
                    ...
                    <li>
                        ...
                        <input type="text" id="reg_mb_name" name="mb_name"
                               value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?>
                               class="frm_input full_input <?php echo $required ?> <?php echo $name_readonly ?>"
                    ...
                    <li>
                        ...
                        <input type="text" name="mb_email"
                               ...
                               maxlength="100" placeholder="E-mail">
                    </li>
                    ...
                    <?php if ($config['cf_use_homepage']) { ?>
                        <li>
                            ...
                            <input type="text" name="mb_homepage" value="<?php echo get_text($member['mb_homepage']) ?>"
                                   ...
                                   size="70" maxlength="255" placeholder="홈페이지">
                        </li>
                    <?php } ?>
                    ...
                    <li>
                        <?php if ($config['cf_use_tel']) { ?>
                            ...
                            <input type="text" name="mb_tel" value="<?php echo get_text($member['mb_tel']) ?>"
                                   ...
                                   class="frm_input full_input <?php echo $config['cf_req_tel'] ? "required" : ""; ?>"
                    ...
                    <li>
                        <?php if ($config['cf_use_hp'] || ($config["cf_cert_use"] && ($config['cf_cert_hp'] || $config['cf_cert_simple']))) { ?>
                            ...
                            <input type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>"
                                   ...
                                   class="frm_input full_input <?php echo $hp_required; ?> <?php echo $hp_readonly; ?>"
                    ...
                    <?php if ($config['cf_use_addr']) { ?>
                        <li>
                            ...
                            <input type="text" name="mb_addr2" value="<?php echo get_text($member['mb_addr2']) ?>"
                                   id="reg_mb_addr2" class="frm_input frm_address full_input" size="50"
                                   placeholder="상세주소">
                            <label for="reg_mb_addr2" class="sound_only">상세주소</label>
                            <br>
                            <input type="text" name="mb_addr3" value="<?php echo get_text($member['mb_addr3']) ?>"
                                   id="reg_mb_addr3" class="frm_input frm_address full_input" size="50"
                    ...
                    <?php if ($config['cf_use_signature']) { ?>
                        <li>
                            ...
                            <textarea name="mb_signature"
                                      id="reg_mb_signature" <?php echo $config['cf_req_signature'] ? "required" : ""; ?> class="<?php echo $config['cf_req_signature'] ? "required" : ""; ?>"
                    ...
                    <?php if ($config['cf_use_profile']) { ?>
                        <li>
                            ...
                            <textarea name="mb_profile"
                                      id="reg_mb_profile" <?php echo $config['cf_req_profile'] ? "required" : ""; ?> class="<?php echo $config['cf_req_profile'] ? "required" : ""; ?>"
...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
                    ...
                    <li class="chk_box">
                        <input type="checkbox" name="mb_mailling" value="1"
                               id="reg_mb_mailling" <?php echo ($w == '' || $member['mb_mailling']) ? 'checked' : ''; ?>
                               class="selec_chk">
                    ...
                    <?php if ($config['cf_use_hp']) { ?>
                        <li class="chk_box">
                            <input type="checkbox" name="mb_sms" value="1"
                                   id="reg_mb_sms" <?php echo ($w == '' || $member['mb_sms']) ? 'checked' : ''; ?>
                                   class="selec_chk">
                    ...
                    <?php if (isset($member['mb_open_date']) && $member['mb_open_date'] <= date("Y-m-d", G5_SERVER_TIME - ($config['cf_open_modify'] * 86400)) || empty($member['mb_open_date'])) { // 정보공개 수정일이 지났다면 수정가능 ?>
                        <li class="chk_box">
                            <input type="checkbox" name="mb_open" value="1"
                                   id="reg_mb_open" <?php echo ($w == '' || $member['mb_open']) ? 'checked' : ''; ?>
                                   class="selec_chk">
                    ...
                    // Social login provider management has been removed
                    ?>
